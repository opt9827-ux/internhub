...
export default function AdminPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault()
    if (username === "internhubvce" && password === "Vmeg@777") {
      setIsLoggedIn(true)
    ...
    try {
      ...
      const res = await fetch("/api/admin", {
        ...
        headers: { 
          ...
          "Authorization": `Basic ${btoa("internhubvce:Vmeg@777")}`
        },
        ...
        {!isLoggedIn ? (
          <>
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-black text-white px-6 py-3 rounded-lg font-medium hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black transition-all"
              >
                Login
              </button>
            </form>
          ...
          <>
            <div className="mb-8 flex justify-between items-center">
              ...
              <button
                ...
                className="bg-red-500 text-white px-4 py-2 rounded-lg font-medium hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-all"
              >
                Logout
              </button>
            </div>
